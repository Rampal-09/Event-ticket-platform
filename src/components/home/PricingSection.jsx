                            ...
                            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 space-y-6">
                                <div className="text-center space-y-1">
                                    ...
                                    <div className="flex items-baseline justify-center gap-2">
                                        ...
                                        <span className="text-indigo-300 text-lg font-bold">upfront</span>
                                    </div>
                                    <p className="text-indigo-200 text-sm font-medium">
                                        Small service fee only on sales
                                    </p>
                                </div>
                                ...
                                <ul className="space-y-3 text-sm">
                                    {['Unlimited events', 'Unlimited ticket types', 'Real-time analytics', 'Email confirmations', 'QR entry scanning'].map((item) => (
