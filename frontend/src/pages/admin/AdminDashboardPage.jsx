...
const AdminDashboardPage = () => {
    ...
    const stats = [
        {
            label: 'Total Users', value: realStats?.totalUsers || '0', trend: 0, color: 'indigo', icon: (
        ...
        {
            label: 'Total Events', value: realStats?.totalEvents || '0', trend: 0, color: 'emerald', icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
            label: 'Pending Reviews', value: realStats?.pendingEvents || '0', trend: 0, color: 'amber', icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
            label: 'Total Revenue', value: `$${(realStats?.revenue || 0).toLocaleString()}`, trend: 0, color: 'rose', icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    if (isLoading) {
        return <div className="py-20 text-center font-black text-gray-400 uppercase tracking-widest">Loading Dashboard Stats...</div>;
    }
